...
const Index = (props: IndexProps) => {
  ...
  const {
    ...
    isBookmarkAdded :state.Bookmarks.isBookmarkAdded
  }));
  ...
  */
  ...
  useEffect(() => {
    if (isBookmarkDeleted || isBookmarkUpdated ||isBookmarkAdded) {
      dispatch(getBookmarks());
    }
  }, [dispatch, isBookmarkDeleted, isBookmarkUpdated, isBookmarkAdded]);
